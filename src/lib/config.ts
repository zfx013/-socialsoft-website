...
export const programmesFormation = [
  {
    ...
    lieu: 'Les 3 Fontaines, Hall A - Les terrasses, 95000 Cergy',
    modalite: 'Présentiel',
    tarif: '125 € HT / 150 € TTC par personne',
    capacite: '4 à 10 apprenants',
    description: 'Cette formation vous offre une découverte pratique de Windows, Word, Excel, Outlook et de la navigation sur Internet. Vous apprendrez à organiser votre poste de travail, à naviguer efficacement sur le web, à créer des courriers simples avec Word, à gérer des tableaux basiques dans Excel, et à utiliser Outlook comme messagerie pour vos courriels, vos agendas et bien plus.',
    objectives: [
    ...
    programme: {
      windows: [
        'Présenter l\'environnement Windows : Bureau, menu Démarrer',
        'Gérer les fenêtres et la barre des tâches',
        'Organiser son poste de travail : explorateur de fichiers, favoris, navigation dans l\'arborescence',
        'Gérer les dossiers et fichiers : créer, renommer, déplacer, copier, supprimer',
        'Récupérer un fichier de la Corbeille',
        'Sauvegarder des données sur une clé USB',
      ],
      word: [
        'Présenter l\'environnement Word',
        'Créer, enregistrer, ouvrir et fermer un document',
        'Saisir, modifier, déplacer, sélectionner et supprimer du texte',
        'Mettre en forme les caractères : gras, italique, police, couleur, taille',
        'Mettre en forme les paragraphes : alignements, bordures, retraits, puces',
        'Insérer des symboles et des images',
        'Mettre en page et imprimer',
      ],
      excel: [
        'Présenter l\'environnement Excel',
        'Créer, enregistrer, ouvrir et fermer un classeur',
        'Saisir et modifier le texte et les nombres dans une cellule',
        'Créer une formule de calcul et la recopier',
        'Mettre en forme les cellules : gras, couleur, alignement, bordures',
        'Ajuster les hauteur/largeur des lignes/colonnes',
        'Mettre en page et imprimer',
      ],
      internet: [
        'Utiliser un navigateur : Edge, Chrome et Google',
        'Naviguer et rechercher des informations sur Internet',
        'Créer et accéder à des sites favoris',
        'Consulter l\'historique de navigation',
        'Utiliser le navigateur pour réaliser des visio',
      ],
      outlook: [
        'Accéder à sa messagerie, consulter et répondre à ses mails',
        'Enregistrer un contact',
        'Télécharger les fichiers joints',
        'Créer des dossiers et ranger ses mails',
        'Créer une signature',
        'Créer et partager son agenda',
        'Utiliser efficacement la recherche',
      ],
    },
