...
export const programmesFormation = [
  {
    ...
    description: 'Formation complète pour acquérir les compétences essentielles en bureautique et navigation web.',
    objectives: [
      'Maîtriser l\'environnement Windows',
      'Créer et mettre en forme des documents Word',
      'Utiliser les fonctions essentielles d\'Excel',
  ...
  {
    id: 'excel-avance',
    title: 'Excel avancé : tableaux croisés et automatisation',
    duration: '14 heures (2 jours)',
    level: 'Intermédiaire à avancé',
    description: 'Approfondissez vos compétences Excel avec les tableaux croisés dynamiques et les macros.',
    objectives: [
